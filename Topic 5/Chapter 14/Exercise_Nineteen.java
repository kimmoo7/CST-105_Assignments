package chapter14;
	 ...
	 * Hint: The Unicode for Pi is \u03c0. To display -2Pi, use Text(x, y, "-2\u03c0").
	         For a trigonometric function like sin(x), x is in radians. Use the following
	         loop to add the points to a polyline:
...
public class Exercise_Nineteen extends Application {

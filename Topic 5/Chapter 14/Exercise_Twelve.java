package chapter14;
	/* Write a program that uses a bar chart to display the percentages of the overall
	grade represented by projects, quizzes, midterm exams, and the final exam.
	Suppose that projects take 20% and are displayed in red, quizzes take 10% and 
	are displayed in blue, midterm exams take 30% and are displayed in green, and 
	the final exam takes 40% and is displayed in orange. Use the Rectangle class to
	display the bars. Interested readers may explore the JavaFX BarChart class for 
	further study */
...
public class Exercise_Twelve extends Application {
	@Override 
	public void start(Stage primaryStage) {       
		...
		primaryStage.setTitle("Exercise_Twelve");

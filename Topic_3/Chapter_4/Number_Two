...
public class Number_Two {
	...
	public static void main(String[] args) {
		/* The great circle distance is the distance between two points on the surface of
		   ...
		   average earth radius is 6,371.01 km. Note that you need to convert the degrees
		   into radians using the Math.toRadians method since the Java trigonometric
		   methods use radians. The latitude and longitude degrees in the formula are for
		...
		double distance = 6371.01 * Math.acos(Math.sin(Math.toRadians(x1)) * 
